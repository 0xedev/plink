...
<div class="flex flex-col gap-5 bg-purple-900 p-3 lg:max-w-80">
    ...
    <div>
      <div class="flex items-center gap-1">
        ...
        <Popover.Root>
          ...
          <Popover.Content
            class="z-30 max-w-lg rounded-md bg-white p-3 text-sm font-medium text-purple-950 drop-shadow-xl"
          >
